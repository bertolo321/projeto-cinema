...
function bloquearCopia(Event){
    ...
    <body>
        ...
        $read = new Read;
        $read->ExeRead('listar_filmes', 'WHERE tipo = :tipo LIMIT :limit', 'tipo=DocumentÃ¡rio&limit=6');
        ...
        //$read->FullRead("SELECT * FROM listar_filmes  LIMIT :limit OFFSET :offset", "limit=6&offset=2");

        echo "<div class='container'><h1 class='text-justify'>Documentários</h1><div class='row'>";
