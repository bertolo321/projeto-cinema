...
function bloquearCopia(Event){
    ...
    <body>
        ...
        $read = new Read;
        $read->ExeRead('listar_filmes', 'WHERE tipo = :tipo LIMIT :limit', 'tipo=Legendado&limit=6');
        ...
        echo "<div class='container'><h1 class='text-justify'>Filmes legendados</h1><div class='row'>";
