...
function bloquearCopia(Event){
    ...
    <body>
        ...
        $read = new Read;
        $read->ExeRead('listar_filmes', 'WHERE tipo = :tipo LIMIT :limit', 'tipo=AÃ§Ã£o&limit=6');
        ...
        echo "<div class='container'><h1 class='text-justify'>Filmes de ação</h1><div class='row'>";
