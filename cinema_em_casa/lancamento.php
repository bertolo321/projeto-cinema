...
function bloquearCopia(Event){
    ...
    <body>
        ...
        /**
          View::Load('_filmes/_acao/img');
         * */
        $read = new Read;
        $read->ExeRead('listar_filmes', 'WHERE tipo = :tipo LIMIT :limit', 'tipo=LanÃ§amentos&limit=6');
        ...
        echo "<div class='container'><h1 class='text-justify'>Lançamentos</h1><div class='row'>";
